...
var polyTests = []struct {
	...
	},
	{
		incorrect: true,
		key: [32]byte{
			0x5d, 0x3c, 0x25, 0xb6, 0x25, 0xc6, 0x5f, 0x29,
			0x69, 0xb4, 0x1a, 0x2e, 0xb8, 0xd4, 0x9a, 0x3a,
			0x0b, 0x94, 0xce, 0xe8, 0x41, 0x2c, 0x36, 0x90,
			0xa9, 0x3f, 0xac, 0xce, 0x94, 0xdc, 0x08, 0x20,
		},
		nonce: [12]byte{
			0xc2, 0x10, 0xca, 0xb1, 0xb0, 0x2c, 0xca, 0x3e,
			0xf4, 0x0a, 0xd7, 0x9f,
		},
		aad: []byte{
		...
		cipher: []byte{
			0xd2, 0xa5, 0xc2, 0x9e, 0x67, 0x49, 0x62, 0xaf,
			0x47, 0x6e, 0xda, 0x6c, 0x2e, 0xf1, 0x9d, 0x4a,
			0x8a, 0x1f, 0x14, 0xb5, 0x0f, 0xfd, 0xd2,
		},
	},
	{
		incorrect: true,
		key: [32]byte{
			0xf0, 0x21, 0x57, 0xd4, 0xad, 0x0b, 0xd5, 0x33,
			0x8e, 0x54, 0x1c, 0xe6, 0x35, 0x3f, 0x89, 0x35,
			0xc0, 0xd7, 0xad, 0x36, 0xc4, 0x25, 0xa2, 0x7d,
			0x65, 0x57, 0x40, 0xba, 0x6e, 0xb6, 0xa7, 0x45,
		},
		nonce: [12]byte{
			0xe4, 0x53, 0xf4, 0x2c, 0xc9, 0x61, 0x8c, 0x6c,
			0xc6, 0x1d, 0x28, 0x25,
		},
		aad: []byte{
			0x17, 0x03, 0x03, 0x00, 0x17,
		...
		cipher: []byte{
			0xd2, 0x82, 0x63, 0xb5, 0xb4, 0x4a, 0x07, 0x95,
			0x3e, 0x86, 0x37, 0xde, 0xf6, 0xc7, 0x27, 0xf5,
			0x9a, 0x1a, 0x7b, 0xb0, 0x76, 0x82, 0xb0,
		},
	},
	{
		incorrect: true,
		key: [32]byte{
			0x39, 0xa8, 0x22, 0xed, 0x40, 0x2d, 0x41, 0x88,
			0x0e, 0x37, 0x6c, 0x1c, 0x99, 0xa5, 0x68, 0x79,
			0x34, 0x05, 0xbd, 0x8c, 0x49, 0xa6, 0x06, 0x39,
			0x5f, 0xa6, 0x39, 0xbf, 0x47, 0xae, 0xb0, 0x1f,
		},
		nonce: [12]byte{
			0xf7, 0xdb, 0x5b, 0xe1, 0xa1, 0x0f, 0xb6, 0xda,
			0xbf, 0x18, 0xfa, 0x9a,
		},
		aad: []byte{
			0x17, 0x03, 0x03, 0x00, 0x17,
		...
		cipher: []byte{
			0xd8, 0xff, 0x0d, 0x91, 0xce, 0xf5, 0x27, 0x9f,
			0x44, 0x31, 0x6e, 0x15, 0xdc, 0xa0, 0x92, 0x0f,
			0x47, 0xf1, 0x3e, 0x0f, 0xf5, 0x29, 0x49,
		},
	},
}
